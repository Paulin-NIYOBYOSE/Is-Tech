const Hero = () => {
    return (
        <div className="sans text-3xl text-green-900 mt-4 bg-green-100 overflow-hidden  md:p-8">
            <div className="flex justify-between items-center flex-wrap">
                ...
                <div className="relative w-full md:w-auto flex items-center justify-center">
                    ...
                    <img src="/images/Electronics.png" alt="Electronics" className="w-full pt-10" />
                </div>
            </div>
        </div>
    );
