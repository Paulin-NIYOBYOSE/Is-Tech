const Hero = () => {
    return (
        <div className="sans text-3xl text-green-900 mt-4 bg-green-100 overflow-hidden md:h-[450px] px-8">
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center justify-center">
                    <img src="/images/Electronics.png" alt="Electronics" className="w-96" />
                    <a href="https://wa.me/%2B250783644486?text=Hello">
                        <div className="bg-green-500 rounded-full w-16 h-16 flex items-center justify-center ml-4">
                            <svg
